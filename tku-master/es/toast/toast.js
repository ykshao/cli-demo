  ...
  methods: {
    toggleClickale: function toggleClickale() {
      ...
      if (this.clickable !== clickable) {
        ...
        document.body.classList[action]('tk-toast--unclickable');
      }
    }
  }
});